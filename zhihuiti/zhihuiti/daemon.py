        ...
        try:
            ...
            while self.current_round < self.max_rounds:
                ...
                try:
                    ...
                    # Never let a single round kill the daemon
                    console.print(
                        f"[red bold]Round {self.current_round} crashed unexpectedly:[/red bold] {exc}"
                    )
                    self.round_results.append({
                        "goal": self.goal,
                        "tasks": [],
                        "error": f"round crash: {exc}",
                        "_daemon_meta": {
                            "round": self.current_round,
                            "elapsed_s": 0,
                            "tokens_this_round": 0,
                            "tokens_cumulative": self.total_tokens_used,
                        },
                    })
